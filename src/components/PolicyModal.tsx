      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/[0.08] bg-white/[0.02] shrink-0">
          ...
          <button
            ...
            className="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-white/[0.05] shrink-0"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 border-t border-white/[0.08] bg-white/[0.02] flex justify-end shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 rounded-xl bg-white/[0.05] hover:bg-white/[0.1] text-xs font-semibold text-white transition-colors"
          >
            Close
          </button>
        </div>
