  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 hidden sm:flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/40 backdrop-blur-[2px]">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white/90 hover:bg-white text-slate-900 text-xs font-bold shadow-xl transform scale-95 hover:scale-100 transition-all"
          >
      ...
      <div className="flex flex-col flex-1 p-3.5 sm:p-5">
        ...
        <h3
          onClick={() => onSelect(product)}
          className="font-display text-xl sm:text-2xl font-bold tracking-wide text-white group-hover:text-red-400 transition-colors line-clamp-2 min-h-[3rem] cursor-pointer mb-2"
        >
          {product.name}
        </h3>
        ...
        <div className="mt-auto pt-2.5 sm:pt-3 border-t border-white/[0.07] flex items-center justify-between">
          <div>
            ...
            <div className="flex items-baseline gap-2">
              ...
              {product.originalPrice && product.originalPrice > product.price && !product.variations && (
          ...
          <button
            ...
            className={`p-2.5 rounded-xl text-xs font-semibold border transition-all min-h-[44px] min-w-[44px] flex items-center justify-center ${
              isInInquiry
        ...
        <div className="grid grid-cols-2 gap-2 mt-3.5 sm:mt-4">
          <button
            onClick={() => onSelect(product)}
            className="flex items-center justify-center gap-1 py-2.5 px-3 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-xs font-semibold text-slate-200 border border-white/[0.08] transition-all min-h-[44px]"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-gradient-to-r from-[#CB2522] to-[#b01e1b] hover:from-[#d82d29] hover:to-[#CB2522] text-xs font-bold text-white shadow-[0_0_15px_rgba(203,37,34,0.35)] hover:shadow-[0_4px_20px_rgba(203,37,34,0.5)] transition-all transform active:scale-95 min-h-[44px]"
          >
